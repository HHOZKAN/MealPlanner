...
class _EditExpenseModalState extends ConsumerState<EditExpenseModal> {
  ...
  void initState() {
    ...
    _selectedIngredientId = widget.expense.ingredientId;
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text(
                                      '${widget.expense.createdAt.day} ${_getMonthName(widget.expense.createdAt.month)} ${widget.expense.createdAt.year}',
  ...
  Future<void> _updateExpense() async {
    ...
    try {
      ...
      // Envoyer la mise à jour au backend
            await notifier.updateExpense(widget.expense.id, expense);
